<footer class="site-footer">
    <div class="container footer-grid">
        <div class="footer-col">
            <img src="assets/img/logo.png" alt="<?= sanitize(setting('site_name', 'Stitch & Souls')) ?>" style="height:60px;opacity:.92;">
            ...
            <div class="footer-social">
                ...
                <a href="https://wa.me/<?= sanitize(setting('whatsapp_number')) ?>?text=<?= urlencode(setting('whatsapp_message', 'Hi, I would like to know more.')) ?>" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i></a>
                <?php endif; ?>
            </div>
        </div>
        <div class="footer-col">
...
<?php if (setting('show_whatsapp_button') === '1' && setting('whatsapp_number')): ?>
<a href="https://wa.me/<?= sanitize(setting('whatsapp_number')) ?>?text=<?= urlencode(setting('whatsapp_message', 'Hi, I would like to know more.')) ?>"
   target="_blank" rel="noopener" class="wa-float-btn" aria-label="Chat on WhatsApp">
